            ...
            <table style="width: 100%; margin-top: 10px;">
                ...
                <tr>
                    <td colspan="14" rowspan="2"
                        ...
                        <br/><br/><b>RFC:</b> <#outputformat "XML">${dataXML.Receptor.atributos.Rfc}</#outputformat><br/></td>
                    <td></td>
        ...
        <#else>
            <table style="width: 100%; margin-top: 10px;">
                ...
                <#if record.customer.custentity_mx_sat_registered_name?has_content>
                    <td colspan="14" rowspan="2"
                        style="border: 1px; border-color: #e3e3e3; font-size:9px;">${record.customer.custentity_mx_sat_registered_name}<br/><br/><b>RFC:</b> <#outputformat "XML">${record.custbody_mx_customer_rfc?upper_case}</#outputformat>
                        <br/></td>
                        <#else>
                        <td colspan="14" rowspan="2"
                        style="border: 1px; border-color: #e3e3e3; font-size:9px;">${record.customer.altname}<br/><br/><b>RFC:</b> <#outputformat "XML">${record.custbody_mx_customer_rfc?upper_case}</#outputformat>
                        <br/></td>
                        </#if>
                    <td></td>
...
<td colspan= "18" style="width: 100%; font-size:10px;">${record.memo}</td>
    ...
    <table style="width: 100%; margin-top: 10px; padding: 0; border: 0px; border-color: #e3e3e3;">
        ...
        <tr>
            ...
            <td colspan="2" style="font-size: 7pt;">${companyInformation.zip}</td>
